...
```bash
curl -fsSL https://raw.githubusercontent.com/hahaaa789/bietaixian/main/haha2.sh -o haha2.sh && chmod +x haha2.sh && ./haha2.sh
```

### 中文版：国内服务器使用

```bash
curl -fsSL https://ghfast.top/https://raw.githubusercontent.com/hahaaa789/bietaixian/main/haha2.sh -o haha2.sh && chmod +x haha2.sh && ./haha2.sh
```

### 英文版：国外服务器使用

```bash
curl -fsSL https://raw.githubusercontent.com/hahaaa789/bietaixian/main/haha2english.sh -o haha2.sh && chmod +x haha2.sh && ./haha2.sh
```
